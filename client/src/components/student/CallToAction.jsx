...
const CallToAction = () => {
  return (
    ...
    pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Expedita animi consequuntur, nemo eaque voluptatibus eligendi dolorum deleniti aliquam dolores, atque
        voluptates unde quas.</p>
